export const fallbackPortfolio = {
  ...
  skills: [
    ...
    { name: "SQL", level: 82, category: "Data Analysis" },
    {
      name: "Classification & Clustering",
      level: 80,
      category: "Machine Learning",
    },
    { name: "Predictive Modeling", level: 78, category: "Machine Learning" },
    { name: "Vercel", level: 85, category: "Cloud Computing" },
  ...
  projects: [
    {
      id: 1,
      title: "Customer Segmentation in Banking",
      description:
